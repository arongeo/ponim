...
class Cognition(nn.Module):
    def __init__(self, hidden_size, latent_dim_size, device, num_layers=1):
        ...
        self.gru = nn.GRU(USER_INPUTS_SIZE, hidden_size, batch_first=True, num_layers=num_layers, dropout=(0.3 if 1 < num_layers else 0.0))
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        o, self.h = self.gru(inputs, self.h)
        o = self.dropout(o)
